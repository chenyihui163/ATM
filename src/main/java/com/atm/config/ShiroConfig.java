...
import com.atm.shiro.KickoutSessionControlFilter;
import com.atm.shiro.RedisShiroSessionDao;
import com.atm.shiro.UserRealm;
...
public class ShiroConfig {
	...
	@Bean("sessionManager")
	public SessionManager sessionManager(RedisShiroSessionDao redisShiroSessionDao, @Value("${atm.redis.open}") boolean redisOpen,@Value("${atm.shiro.redis}") boolean shiroRedis )
	{
